...
static const flex_int16_t yy_base[23] =
    {   0,
        0,    0,   23,   24,    0,    0,   18,   17,   16,    0,
        0,    0,   15,    0,    0,   24,   14,   13,    5,    8,
       10,   12
    } ;

static const flex_int16_t yy_def[23] =
    {   0,
       16,    1,   16,   16,   17,   18,   19,   19,   20,   21,
        8,   22,   20,   21,   22,    0,   16,   16,   16,   16,
       16,   16
    } ;

static const flex_int16_t yy_nxt[31] =
    {   0,
        4,    5,    6,    4,    4,    7,   11,   11,   11,   13,
       13,   13,   14,   14,   15,   15,    9,    8,   12,   12,
       10,   10,   16,    3,   16,   16,   16,   16,   16,   16
    } ;

static const flex_int16_t yy_chk[31] =
    {   0,
        1,    1,    1,    1,    1,    1,   19,   19,   19,   20,
       20,   20,   21,   21,   22,   22,   18,   17,   13,    9,
        8,    7,    3,   16,   16,   16,   16,   16,   16,   16
    } ;
